...
my_text = """One of the most important things I didn't understand about the world when I was a child is the degree to which the returns for performance are superlinear.
...
# create text splitter object and pass size and other

# size 100, split on basis of none, overlap is used for overlapping text
# chunk overlap is used to maintain context between chunks

# splitter = CharacterTextSplitter(chunk_size=100, chunk_overlap=0, separator="")

# result = splitter.split_text(my_text)

# print(result)
# print(result[2])


# Combine splitter and document loader

loader = PyPDFLoader("sample.pdf")

docs = loader.load()

# send pdf to splitter
splitter = CharacterTextSplitter(chunk_size=100, chunk_overlap=0, separator="")
